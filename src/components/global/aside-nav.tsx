                ...
                <div className="aside-nav__main">
                    <ul className="aside-nav__list">
                        <li className="aside-nav__item">
                            <Link to="/" className="aside-nav__link" activeClassName="aside-nav__link--active" >
                        ...
                        <li className="aside-nav__item">
                            <Link to="/statistics/" className="aside-nav__link" activeClassName="aside-nav__link--active">
