    ...
    return (
        <aside className="aside-nav">
            <div className="aside-nav__container">
                ...
                {/* <div className="aside-nav__footer">
                    <span>0.0.1</span>
                    <a href="/">Changelog</a>
                </div> */}
            </div>
